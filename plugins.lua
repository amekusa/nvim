		...
		config = function()
			...
			require('nvim-tree').setup({
				...
				on_attach = function(buf)
					...
					map('nvim-tree: Up',                     'n', 'h',              api.tree.change_root_to_parent,   opts)
					...
					map('nvim-tree: Open: System',           'n', '<2-RightMouse>', api.node.run.system,              opts)
					...
					map('nvim-tree: Close Directory',        'n', 'x',              api.node.navigate.parent_close,   opts)
					map('nvim-tree: Collapse All',           'n', 'X',              api.tree.collapse_all,            opts)
					map('nvim-tree: Expand All',             'n', 'A',              api.tree.expand_all,              opts)
