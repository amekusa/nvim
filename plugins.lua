		...
		config = function()
			...
			require('nvim-tree').setup({
				...
				on_attach = function(buf)
					...
					map('nvim-tree: Prev Git',               'n', '<Leader>k',     api.node.navigate.git.prev,     opts)
					map('nvim-tree: Next Git',               'n', '<Leader>j',     api.node.navigate.git.next,     opts)
					...
					map('nvim-tree: Filter',                 'n', 'F',             api.live_filter.start,          opts)
					map('nvim-tree: Clear Filter',           'n', '<Esc>',         function()
